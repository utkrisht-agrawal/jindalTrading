...
DROP DATABASE IF EXISTS `jindaltrading`;
...
DROP TABLE IF EXISTS `customer_firms`;
...
DROP TABLE IF EXISTS `cust_categories`;
...
-- Dumping data for table jindaltrading.cust_categories: ~2 rows (approximately)
DELETE FROM `cust_categories`;
INSERT INTO `cust_categories` (`customerId`, `customerName`, `category`, `createdAt`, `updatedAt`) VALUES
	(65, 'King Kholi', 'Retail', '2023-03-29 18:15:25', '2023-03-29 18:15:25'),
	(66, 'a', 'Retail', '2023-03-29 18:37:39', '2023-03-29 18:37:39');
...
-- Dumping data for table jindaltrading.cust_contacts: ~2 rows (approximately)
...
INSERT INTO `cust_contacts` (`customerId`, `mobileNumber`, `customerName`, `designation`, `email`, `createdAt`, `updatedAt`) VALUES
	(89, NULL, 'King Kholi', '', '', '2023-03-29 18:15:25', '2023-03-29 18:15:25'),
	(90, 1112223333, 'a', '', '', '2023-03-29 18:37:39', '2023-03-29 18:37:39');

-- Dumping structure for table jindaltrading.cust_firms
DROP TABLE IF EXISTS `cust_firms`;
...
-- Dumping data for table jindaltrading.cust_firms: ~2 rows (approximately)
DELETE FROM `cust_firms`;
INSERT INTO `cust_firms` (`customerId`, `customerName`, `firm`, `createdAt`, `updatedAt`) VALUES
	(16, 'King Kholi', NULL, '2023-03-29 18:15:25', '2023-03-29 18:15:25'),
	(17, 'a', NULL, '2023-03-29 18:37:39', '2023-03-29 18:37:39');

-- Dumping structure for table jindaltrading.cust_product
DROP TABLE IF EXISTS `cust_product`;
...
-- Dumping data for table jindaltrading.cust_products: ~1 rows (approximately)
DELETE FROM `cust_products`;
INSERT INTO `cust_products` (`customerId`, `customerName`, `product`, `createdAt`, `updatedAt`) VALUES
	(113, 'King Kholi', 'PIG IRON', '2023-03-29 18:15:25', '2023-03-29 18:15:25');
...
DROP TABLE IF EXISTS `logintables`;
...
DROP TABLE IF EXISTS `market_plan_allotments`;
...
DROP TABLE IF EXISTS `market_plan_pig_irons`;
...
DROP TABLE IF EXISTS `market_plan_quantity_ledgers`;
...
DROP TABLE IF EXISTS `mastercustomers`;
...
DROP TABLE IF EXISTS `masterustomers`;
...
DROP TABLE IF EXISTS `master_custs`;
...
-- Dumping data for table jindaltrading.master_employees: ~4 rows (approximately)
...
DROP TABLE IF EXISTS `master_firms`;
...
-- Dumping data for table jindaltrading.master_firms: ~0 rows (approximately)
...
DROP TABLE IF EXISTS `master_product_groups`;
...
-- Dumping data for table jindaltrading.master_teams: ~6 rows (approximately)
...
DROP TABLE IF EXISTS `transport_contacts`;
...
DROP TABLE IF EXISTS `transport_trucks`;
...
DROP TABLE IF EXISTS `truck number details`;
...
DROP TABLE IF EXISTS `ven_categories`;
...
DROP TABLE IF EXISTS `ven_contacts`;
...
DROP TABLE IF EXISTS `ven_firm_details`;
